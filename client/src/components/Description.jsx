    ...
    my-24 p-6 md:px-28'>
        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            <div>
                ...
                <p className='text-gary-600 mb-4'>Easily bring your ideas to life with our free AI
                ...
                <p className='text-gray-600'>Simply type in a text prompt, and our curtting-edge
                    AI will generate high-quality images in seconds. From
                    product visuals to character designs and portraita, 
